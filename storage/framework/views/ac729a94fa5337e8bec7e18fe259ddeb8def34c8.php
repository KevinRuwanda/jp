...
<head>
    ...
    <title>FishShop - <?php echo $__env->yieldContent('title'); ?></title>
...
<script src="<?php echo e(asset('js/tinymce/tinymce.min.js')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(asset('js/tinymcescript.js')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(asset('js/lightbox.js')); ?>" type="text/javascript"></script>
